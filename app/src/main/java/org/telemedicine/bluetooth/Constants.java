...
public interface Constants {
    ...
    public static final String PULSE_DEVICE = "Sp";
    public static final int PULSE_DEVICE_NUM = 101;

    public static final String BP_DEVICE = "NIBP";
    public static final int BP_DEVICE_NUM = 102;

    public static final String EET_DEVICE = "TEMP";
    public static final int EET_DEVICE_NUM = 103;

    public static final String FET_DEVICE = "FHR";
    public static final int FET_DEVICE_NUM = 104;

    public static final String BLOOD_DEVICE = "BG";
...
//	public static final int BP_DEVICE_NUM = 102;
//
//	public static final String EET_DEVICE = "TEMP010210";
//	public static final int EET_DEVICE_NUM = 103;
//
